...
class DoclingParser:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.ocr_converter = DocumentConverter(
                allowed_formats=[InputFormat.PDF, InputFormat.DOCX],
                format_options={
                    InputFormat.PDF: PdfFormatOption(
    ...
    def parse(self, file_path: str) -> str:
        ...
        if extension == ".pdf":
            ...
            if page_count > PARALLEL_PAGE_THRESHOLD:
                logger.info(f"Document has {page_count} pages. Activating Parallel Parsing...")
    ...
    def parse_parallel(self, file_path: str, total_pages: int) -> str:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            logger.info(f"Spawning {len(pdf_parts)} workers for parallel ingestion...")
